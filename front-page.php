...
<body>
    <div class="banner">
        <div class="gold-rect"></div>
        <div class="title"><h1><?php printf( get_theme_mod('banner_heading', __( 'Live a Golden Life', 'banner_heading' ) )); ?></h1></div>
        <img src="<?php echo get_theme_mod('banner_image',get_bloginfo('template_directory').'/assets/images/Rectangle 40.png' )?>" alt="">
        <div class="description">
            <p><?php printf( get_theme_mod('banner_text', __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Condimentum posuere ullamcorper tempor sed habitasse. Curabitur faucibus in consectetur gravida pellentesque odio egestas. Nec egestas erat mi tristique duis urna lectus libero.', 'banner_text' ) )); ?></p>
    ...
    <div class="community">
            <h1><?php printf( get_theme_mod('second_section_heading', __( 'With Great Community', 'second_section_heading' ) )); ?></h1>
    ...
    <div class="latest-event">
        ...
        <p><?php printf( get_theme_mod('third_section_sales', __( 'Backyard Sale 12-15-2021 <br> Easter Egg Hunt 04-23-2021 <br> Coffee Hours 02-08-2021 <br> Backyard Together 11-16-2021 <br> Pet Celebration 07-10-2021', 'third_section_sales' ) )); ?></p>
        </div>
        <div class="right-latest">
            <h2><?php printf( get_theme_mod('third_section_heading', __( 'Latest Events', 'third_section_heading' ) )); ?></h2>
            <p class="latest_events_events"><?php printf( get_theme_mod('third_section_description', __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Condimentum posuere ullamcorper tempor sed habitasse. ', 'third_section_description' ) )); ?></p>
        </div>       
    </div>
    <div class="best-places">
        <div class="left-best">
            <h2><?php printf( get_theme_mod('fourth_section_heading', __( 'Best Place', 'fourth_section_heading' ) )); ?></h2>
            <p class="latest_events_events"><?php printf( get_theme_mod('fourth_section_paragraph', __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Condimentum posuere ullamcorper tempor sed habitasse. Curabitur faucibus in consectetur gravida pellentesque odio egestas. Nec egestas erat mi tristique duis urna lectus libero. Felis ut vitae pellentesque elit tincidunt lorem velit integer tortor. Viverra sed aenean et purus est.', 'fourth_section_paragraph' ) )); ?></p>
        </div>
